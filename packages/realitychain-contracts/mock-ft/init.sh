...
near call $ft_acc storage_deposit '' --accountId agustinustheo.testnet --amount 0.00125

params2="{\"receiver_id\": \"agustinustheo.testnet\", \"amount\": \"100000000000000000000000\"}"
