...
export const CreateComponent = () => {
  ...
  return (
    <Container
      style={{ marginTop: 24, maxWidth: 888, boxSizing: "border-box" }}
    >
        ...
        <div style={{ display: "flex", gap: 40 }}>
          ...
          <div style={{ width: "100%" }}>
            ...
            <TextField
              ...
              id="outlined-basic"
              fullWidth
              placeholder="Add metaverse name"
            />
            ...
            <div className={style.radio} style={{ marginBottom: 24 }}>
              <Button
                onClick={() => handleChangeType("One owner")}
                className={`${style.button} ${
                  type === "One owner" && style.purple
                }`}
                variant="outlined"
              >
                One owner
              ...
              <Button
                onClick={() => handleChangeType("Crowd Staking")}
                className={`${style.button} ${
                  type === "Crowd Staking" && style.purple
                }`}
                variant="outlined"
              >
                Crowd Staking
            ...
            >
              <ListItem button onClick={handleClick}>
                {selectedBlockchain && (
                  <ListItemIcon>{icons[selectedBlockchain.id]}</ListItemIcon>
                )}
                <ListItemText
                  primary={
                    selectedBlockchain ? selectedBlockchain.name : "Select"
                  }
                />
                ...
                <List component="div" disablePadding dense>
                  {blockchains.map((item) => (
                    <ListItem
                      ...
                      key={item.id}
                      onClick={() => handleSelectBlockchain(item.id)}
                    >
            ...
            <div className={style.radio} style={{ marginBottom: 24 }}>
              <Button
                onClick={() => handleChangeMetaverse("2d")}
                className={`${style.button} ${
                  metaverse === "2d" && style.purple
                }`}
                variant="outlined"
              >
                2d
              ...
              <Button
                onClick={() => handleChangeMetaverse("3d")}
                className={`${style.button} ${
                  metaverse === "3d" && style.purple
                }`}
                variant="outlined"
              >
                3d
            ...
            >
              ...
              <Button
                variant="contained"
                color="primary"
                style={{ width: "auto", fontSize: 13, fontWeight: 400 }}
              >
                Submit
              </Button>
            </div>
