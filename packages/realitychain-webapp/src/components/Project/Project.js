    ...
    return (
      ...
      >
        <Typography variant="h4" style={{ marginBottom: 10 }}>
          Let’s start create metaverse!
        </Typography>
        <Typography variant="subtitle1" style={{ marginBottom: 40 }}>
          Once you had submit project, the progress will appear here. Submit now
          and start minting your NFT Parcels
        </Typography>
    ...
    <Container style={{ marginTop: 24, maxWidth: 1171 }}>
          ...
          <Paper elevation={0} className={style.purplePaper}>
            <div style={{ width: 336 }}>
              ...
              <Typography variant="subtitle1">
                Complete your profile to start create metaverse
              </Typography>
            </div>
      ...
      <div style={{ position: "relative", marginBottom: 24 }}>
        <Button
          ...
          variant="contained"
          color="primary"
          startIcon={<SvgIcon component={PlusIcon} viewBox="0 0 20 20" />}
        >
          create metaverse
        </Button>
        <TabsComponent
