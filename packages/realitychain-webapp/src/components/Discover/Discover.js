...
export const DiscoverComponent = () => {
  ...
  return (
    <Container style={{ marginTop: 24, maxWidth: 1171 }}>
      <div style={{ display: "flex", gap: 24 }}>
        <div style={{ display: "flex", width: 672, flexWrap: "wrap", gap: 24 }}>
          <Paper className={style.paper}>
            <Typography
              style={{ marginTop: 46, marginBottom: 14 }}
              variant="h2"
            >
              Welcome to
            </Typography>
            <Typography style={{ marginBottom: 19 }} variant="h1">
              Reality Chain
            </Typography>
            <Button
              variant="contained"
          ...
          <Paper elevation={0} className={style.blackPaper}>
            <div
              className={style.box}
              style={{ backgroundColor: "rgba(232, 196, 71, 0.2)" }}
            >
              <SvgIcon
                component={DollarIcon}
                viewBox="0 0 20 20"
                style={{ color: "rgba(232, 196, 71, 1)" }}
              />
            </div>
          ...
          <Paper elevation={0} className={style.blackPaper}>
            <div
              className={style.box}
              style={{ backgroundColor: "rgba(205, 155, 222, 0.2)" }}
            >
              <SvgIcon
          ...
          <Paper elevation={0} className={style.blackPaper}>
            <div
              className={style.box}
              style={{ backgroundColor: "rgba(125, 233, 181, 0.2)" }}
            >
              <SvgIcon
                component={GiftIcon}
                viewBox="0 0 20 20"
                style={{ color: "rgba(125, 233, 181, 1)" }}
              />
            </div>
            <Typography color="textSecondary" style={{ fontSize: 13 }}>
              NFT Parcel
        ...
        <div style={{ width: "100%" }}>
          <Typography style={{ marginBottom: 13 }} variant="h3">
            <Typography
              component="span"
              variant="h3"
              style={{ color: "rgba(255, 104, 233, 1)" }}
            >
              Top 5{" "}
            </Typography>
            Asset Creator
          ...
          <Paper
            style={{ width: "100%", height: "calc(100% - 48px)", padding: 24 }}
          >
            <TablesComponent />
          </Paper>
        </div>
      ...
      <div
        style={{ display: "flex", flexWrap: "wrap", gap: 20, marginBottom: 24 }}
      >
        <Paper style={{ width: 264, padding: 12 }}>
          <Paper
            style={{
              ...
              height: 240,
              background:
                "linear-gradient(276.23deg, #1E3787 11.51%, #6339A6 89.52%)",
            }}
          />
            ...
            >
              <div
                style={{
                  ...
                  height: 4,
                  background:
                    "linear-gradient(91.46deg, #FF68E9 2.35%, #5B44FA 54.7%, #5DDEDE 99.93%)",
                }}
              />
            </div>
